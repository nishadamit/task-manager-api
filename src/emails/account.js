...
// const sendGridApiDev = process.env.SENDGRID_API_KEY;
const sendGridApiProduction =
  "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";

sgMail.setApiKey(sendGridApiProduction);
